...
function App() {
  ...
  return (
    ...
    <img src="https://i.ibb.co/khYQh2K/icons8-chatgpt-64.png" class="h-16 pt-5 pl-7 fixed" alt="Flowbite Logo" />
      <div className="container mx-auto py-24 px-4 md:px-0 max-w-[720px]">
        <form action="" className="text-center" onSubmit={handleSubmit}>
          ...
          <div className="btn my-10 flex flex-row justify-center">
            <button
              type="submit"
              className="text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-teal-500 shadow-lg shadow-teal-200/50 dark:shadow-lg dark:shadow-teal-400/80 font-medium rounded-lg text-md px-9 py-2.5 text-center mr-2 mb-2 font-serif"
            >
              Search
            </button>
          </div>
...
<span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400 sticky bottom-0 left-0 pb-5 right-0">©2023 <span class="">OpenSomething™</span>. All Rights Reserved.</span>
</footer>
